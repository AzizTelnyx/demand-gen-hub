...
import {
  ...
  CheckCircle2, XCircle, Loader2, X, AlertTriangle,
...
/* ═══════════════════════════════════════════════════════
   GUARDRAILS (kept here — complex internal state)
   ═══════════════════════════════════════════════════════ */
  ...
  return (
    <div>
      ...
      <button onClick={() => setOpen(!open)} className="w-full flex items-center gap-2 text-left group">
        ...
        <h2 className="text-base font-semibold text-[var(--text-primary)]">Configuration & Guardrails</h2>
        <span className="text-xs text-[var(--text-muted)] font-normal">— Safety limits, budget rules, regional priorities</span>
      </button>
...
export default function AgentsPage() {
  ...
  return (
    <div className="p-6 space-y-10 max-w-7xl mx-auto">
      ...
      {/* 5. Configuration & Guardrails (collapsible) */}
